...
#else
  G__functionscope compiler;
  return(compiler.compile_normalfunction(ifunc,iexist));
#endif
}
...
#else
  // nothing is goingon in setenv() for now.
  m_bc_inst.setenv(asm_inst_g,&G__asm_cp,asm_stack_g,&G__asm_dt);
...
#ifdef G__OLDIMPLEMENTATION2116
  G__asm_inst = store_asm_inst;
#endif
